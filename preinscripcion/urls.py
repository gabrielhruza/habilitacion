...
urlpatterns = [
    ...
    url(r'^administrador/pni/confirmar/(?P<pid>[0-9]+)/$', views.admin_confirmar, name='admin_confirmar'),
    url(r'^administrador/pni/desconfirmar/(?P<pid>[0-9]+)/$', views.admin_desconfirmar, name='admin_desconfirmar'),
