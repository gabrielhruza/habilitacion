...
;(function($) {
    $.fn.formset = function(opts) {
        ...
        if (allowInitialRender) {
            ...
            addButton.click(function() {
                ...
                /////////////////////////////////////////////////////////////777
                //copio los valores del formulario original en los que agrega
                row_original_fn = $('#id_postulante-fecha_nacimiento').val();
                row_original_ap = $('#id_postulante-apellido').val();
                row_original_dm = $('#id_postulante-domicilio').val();
    ...
    $.fn.formset.defaults = {
        ...
        prefix: 'hno',                  // The form prefix for your django formset
        ...
        addCssClass: 'btn btn-success btn-xs',          // CSS class applied to the add link
        deleteCssClass: 'btn btn-danger btn-xs',    // CSS class applied to the delete link
