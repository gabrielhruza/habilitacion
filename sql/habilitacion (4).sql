...
--
-- Servidor: localhost
-- Tiempo de generación: 07-10-2017 a las 00:03:58
...
(1, 'pbkdf2_sha256$36000$cJBUE4zcZsiu$PYBNBaoxA7+hiUm46VEF8VwIJeiIYwr2SkPiI4UCmqk=', '2017-10-07 02:35:14', 1, 'Habilitacion', '', '', 'habilitacion@gmail.com', 1, 1, '2017-06-26 13:29:58'),
(2, 'pbkdf2_sha256$36000$lfpRUDGP3YKt$vOmCy7mA/lB9Oopf900hkvpZluD3LPXQnEsfUkVmd2w=', '2017-10-06 02:31:18', 0, 'DirectoraNI', '', '', '', 0, 1, '2017-06-26 13:30:58'),
...
(4, 'pbkdf2_sha256$36000$oKybHiHbYTDu$MqUSeSsJ9FCSN0DZuQIEggmPtawOc26VM5bClZx9sAg=', '2017-10-07 02:35:25', 0, 'DirectoraGNI', '', '', '', 0, 1, '2017-09-09 00:39:08'),
(6, 'pbkdf2_sha256$36000$w031KsMzZhDE$VUuHONBdYiVIMEBeQIYJTsp66uiU5Hwu40VgIJfRdyk=', '2017-10-07 02:40:15', 0, 'DirectoraGNP', '', '', '', 0, 1, '2017-09-12 23:08:25'),
(7, 'pbkdf2_sha256$36000$ULvU6sfKnlzM$VaWaRg3CDbwuf9aj2EHAMJT3rUd9Xypqt5xxfErQTis=', '2017-10-07 02:24:04', 0, 'DirectoraGNS', '', '', '', 0, 1, '2017-09-12 23:09:37'),
(8, 'pbkdf2_sha256$36000$PjlRR7quSbPl$xR2WJyuOMG9IkLIi+YfR2LXMjXV76s2A6fZfVEix0W0=', '2017-10-07 02:24:17', 0, 'Recepcion', '', '', '', 0, 1, '2017-09-29 18:56:08');
...
INSERT INTO `mes_nota` (`id`, `fecha_emision`, `estado`, `emisor_id`, `receptor_id`, `nro_de_tracking`, `remitente`, `notificar`, `motivo`, `motivo_derivar`, `accion_por_id`, `emisor_perfil_id`) VALUES
(149, '2017-10-06', 'NUEVA', 6, 20, '81404102', 'Andres Garcia', 0, 'Consulta saldo.', '', NULL, 21),
(150, '2017-10-06', 'NUEVA', 6, 23, '85249865', 'Andres Garcia', 0, 'Consulta vacante.', '', NULL, 23),
(151, '2017-10-06', 'NUEVA', 4, 20, '24111366', 'Andres Garcia', 0, 'Consulta saldo.', '', NULL, 21),
(152, '2017-10-06', 'NUEVA', 4, 22, '06204347', 'Andres Garcia', 0, 'Consulta vacante.', '', NULL, 22),
(153, '2017-10-06', 'RECIBIDA', 8, 22, '23987765', 'Andres Garcia', 0, 'Consulta', '', 4, 20),
(154, '2017-10-06', 'EN TRÁMITE', 8, 21, '19021123', 'Andres Garcia', 0, 'Consulta saldo.', '', 4, 20),
(155, '2017-10-06', 'NUEVA', 8, 22, '79375397', 'Andres Garcia', 0, 'Consulta vacante.', '', NULL, 20),
(156, '2017-10-06', 'NUEVA', 6, 14, '19021123', 'Andres Garcia', 1, 'Consulta', 'Pasó a trámite.', NULL, NULL),
(157, '2017-10-06', 'NUEVA', 6, 14, '19021123', 'Andres Garcia', 1, 'Consulta', 'Pasó a trámite.', NULL, 20),
(158, '2017-10-06', 'NUEVA', 6, 17, '85249865', 'Andres Garcia', 1, 'Consulta', 'Pasó a trámite.', NULL, 23);
...
INSERT INTO `preinscripcion_preinscripcion4anios` (`id`, `fecha`, `hora`, `nro_de_preinscripto`, `estado`, `fecha_confirmado`, `confirmado`, `responsablequeconfirma`, `motivo`, `nro_de_sorteo`, `cicloLectivo_id`, `usuarioqueconfirma_id`) VALUES
(1, '2017-10-03', '12:40:46', '50429142', 'PREINSCRIPTO', NULL, 0, NULL, 'No contesta', 0, 1, NULL),
(2, '2017-10-03', '12:40:46', '03649186', 'PREINSCRIPTO', NULL, 0, NULL, 'No contesta', 0, 1, NULL);
...
(100, '2017-09-29', '14:59:02', '79225888', 'CONFIRMADO', '2017-09-29', 1, NULL, 'No contesta', 'PRIMARIO', '7', 'Escuela actual', 'RESISTENCIA', 'SANTA FE', '262626262', 0, 1, 6, 15),
(101, '2017-09-29', '16:52:15', '85068458', 'CONFIRMADO', '2017-09-29', 1, NULL, 'No contestaNo contestaNo contestaNo contestaNo contesta', 'INICIAL', '2', 'Escuela actual', 'RESISTENCIA', 'SANTA FE', '262626262', 0, 2, 4, 22),
(102, '2017-10-01', '11:42:41', '39345260', 'CONFIRMADO', '2017-10-01', 1, NULL, 'No contestaNo contestaNo contestaNo contestaNo contesta', 'PRIMARIO', '3', 'Escuela actual', 'RESISTENCIA', 'SANTA FE', '262626262', 0, 1, 6, 6),
